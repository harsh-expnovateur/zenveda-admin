  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = editingId
        ? await axiosInstance.put(`/ingredients/${editingId}`, formData, {
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
            <div>
              ...
              <p className="text-gray-600">
                Add, edit, and organize ingredients used in your premium teas
              </p>
            </div>
            <button
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-4xl font-bold text-[#1f513f]">
                  {ingredients.length}
                </p>
              </div>
              <div className="bg-green-100 p-4 rounded-full">
                <svg
                  className="w-8 h-8 text-[#1f513f]"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-2xl shadow-lg p-16 text-center border border-gray-100">
            ...
            <p className="text-gray-500 max-w-md mx-auto">
              Start building your ingredient library by adding the first one!
            </p>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-8">
            {ingredients.map((ingredient) => (
              ...
              >
                ...
                <div className="p-6">
                  <h3 className="text-xl font-bold text-[#1f513f] mb-3 line-clamp-1">
                    {ingredient.name}
                  </h3>
                ...
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-green-100 text-sm">
                      Fill in the details to manage your ingredient
                    </p>
                  </div>
                  <button
                    onClick={closeModal}
